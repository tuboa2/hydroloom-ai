...
from services.behavior_clustering.src.features.data_loader import DataLoader
# fixed: import the hemisphere isolated scaling pipeline
from services.behavior_clustering.src.features.extract_features import north_pipeline, south_pipeline
from services.behavior_clustering.src.features.select_features import FeatureSelection
...
def run(hemisphere: Literal["north", "south"]):
    ...
    assert supported_mask is not None, "vt.get_support() returned None. Is the model fitted?"
